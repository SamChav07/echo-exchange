...
void MDcmp() {
    ...
    do
    {
        ...
        case 1:
            ...
            /*cout<<"Cuantos productos desea facturar?"<<endl;
            cin>>cantidadProd;*/ //pendiente facturar mas de un producto

            cin.ignore();

            
            cout<< "Producto a facturar: ";
            cin.getline(currentCmp.cmpr_prod, sizeof(currentCmp.cmpr_prod));
...
void showCmp(int pos) // muestra los datos del cliente en X posición
{
    ...
    cout << "Producto Facturado: "<< cmp[pos].cmpr_prod<<endl;
